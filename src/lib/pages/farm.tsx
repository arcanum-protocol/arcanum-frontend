...
//         address: address,
//         token: token.address == "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE" ? undefined : token.address as Address,
//     });
                                    ...
                                    <TabsContent className="flex flex-col gap-2" value='stake'>
                                        ...
                                        <div className="flex flex-col items-center rounded border border-[#292524] mt-2 p-2">
                                            ...
                                            <div className="flex flex-row justify-between w-[95%]">
                                                <div className="text-xs leading-4 m-0 text-[13px] text-[#888888] hover:text-[#a1a1a1] transition ease-in-out delay-10 font-light text-left"> = {0}$</div>
                                                <div className="text-xs leading-4 m-0 text-[13px] text-[#888888] hover:text-[#a1a1a1] transition ease-in-out delay-10 font-light text-left">Balance: 0</div>
                                            </div>
                                        </div>


                                        <div className="w-full">
                                            <Button className="w-full border bg-transparent rounded border-green-300 text-slate-50 hover:border-green-500 hover:bg-transparent" disabled={false} onClick={() => setOpen(!open)}>
